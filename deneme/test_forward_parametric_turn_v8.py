...
RESULT_DIR = Path("results_forward_parametric_turn_v8")
...
ns = {"__name__": "parametric_turn_v8_base", "__file__": str(AUTH_SOURCE)}
...
# V8: stronger direct vertical authority.
# V7 proved that ~0.536 collective was not enough to reverse the climb.
COLLECTIVE_FF = 0.5820
ALT_TO_VS_GAIN = 0.08
MAX_UPWARD_VS_CMD = 0.10
MAX_DOWNWARD_VS_CMD = 2.00
UPWARD_VS_GAIN = 0.020
DOWNWARD_VS_GAIN = 0.004
PHYS_COLLECTIVE_MIN = 0.500
...
print("=" * 120)
print("PARAMETRIC FORWARD-FLIGHT TURN V8")
...
try:
    ...
    for step in range(int(MAX_TEST_TIME_S / dt)):
        ...
        trace.append({
            ...
            "vertical_gain": float(last_alt["gain"]),
        ...
        if step % max(1, int(1.0/dt)) == 0:
            print(
                ...
                f"K={last_alt['gain']:.3f} | COLL={last_alt['collective']:.4f} | "
