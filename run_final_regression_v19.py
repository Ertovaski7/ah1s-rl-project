...
VALIDATOR = Path("validate_full_mission_v19_360_transition_trim_0590.py")
ANGLES = [-50, 50, 200, 360]
LOG_DIR = Path("final_regression_logs_v19")
...
def run_case(angle: int) -> dict:
    print("\n" + "=" * 120)
    print(f"FINAL REGRESSION V19 | requested_turn={angle:+d} deg")
    print("=" * 120)
    ...
    passed = (
        proc.returncode == 0
        and full_pass_line == "FULL MISSION PASS: True"
    )
