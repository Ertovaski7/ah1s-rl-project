...
VALIDATOR = Path("validate_full_mission_final_v23.py")
ANGLES = [-50, 50, 200, 360]
LOG_DIR = Path("final_regression_logs_v23")
...
def run_case(angle: int) -> dict:
    print("\n" + "=" * 120)
    print(f"FINAL REGRESSION V23 | requested_turn={angle:+d} deg")
    print("=" * 120)
...
def main() -> int:
    ...
    print("=" * 120)
    print("AH-1S FINAL REGRESSION SUITE — V23")
    print("Angles: -50, +50, +200, +360 deg")
    print("-50 keeps its proven path; +50 uses feedback recovery; +200/+360 use fixed 0.590 transition trim.")
    print("Each case launches the same final validator in a fresh process.")
    print("Per-case full logs are saved under final_regression_logs_v23/.")
    print("=" * 120)

    results = [run_case(angle) for angle in ANGLES]

    print("\n" + "=" * 120)
    print("FINAL REGRESSION MATRIX — V23")
    print("=" * 120)
