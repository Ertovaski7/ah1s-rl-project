...
# The helper was intentionally moved under deneme/ during repo cleanup.
# Rewrite the legacy dependency path before executing the definitions.
...
try:
    ...
    # NEW target heading is assigned only after the turn is completed.
    new_target_heading = (
        mission_heading
        +
        math.radians(
    ...
    for step in range(max_steps):
        ...
        # Update cumulative heading AFTER applying the action.
        ...
        if (
            ...
            # Handoff the newly reached heading to Stage-2 only now.
