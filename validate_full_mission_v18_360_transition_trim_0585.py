...
if old_a not in text:
    raise RuntimeError("V18: post-turn handoff start not found")
...
if old_b not in text:
    raise RuntimeError("V18: previous_action reset not found")
...
if old_action not in text:
    raise RuntimeError("V18: Stage2 post-turn action block not found")
...
if old_print not in text:
    raise RuntimeError("V18: post-turn handoff print not found")
...
if needle not in text:
    raise RuntimeError("V18: post-turn qualification loop not found")
text = text.replace(needle, replacement, 1)

print("=" * 120)
print("V18 DIRECT - 360 TRANSITION TRIM 0.585 -> SMOOTH STAGE2 HANDOFF")
print("Direct V11 base; no nested wrappers. Same FDM; runtime teacher OFF; thresholds unchanged.")
print("360 transition collective=0.585; max settle=20.0s.")
print("=" * 120)
